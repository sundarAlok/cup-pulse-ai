      ...
      <main className="relative">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 space-y-12">
          ...
          <section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <GlassCard>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-1 text-xs text-(--muted)">62 • Lusail Iconic</div>
                  </div>

                  <div className="text-right">
                    <div className="text-sm text-(--muted)">AI Prob</div>
              ...
              <GlassCard>
                ...
                <div className="mt-1 text-xs text-(--muted)">Starts in 4h</div>
              </GlassCard>
          ...
          <section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <GlassCard>
                <div className="text-sm text-(--muted)">Next Match Prediction</div>
                <div className="mt-2 font-bold">Spain vs Germany</div>
                <div className="mt-1 text-xs text-(--muted)">AI: Spain 54% • Confidence: 68%</div>
              </GlassCard>

              <GlassCard>
                <div className="text-sm text-(--muted)">Top Predictions</div>
          ...
          <section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <GlassCard>
                <div className="text-sm text-(--muted)">Your Points</div>
                <div className="mt-2 text-3xl font-extrabold">1,240</div>
                <div className="mt-2 text-xs text-(--muted)">Keep predicting to earn more rewards.</div>
              </GlassCard>

              <GlassCard>
                <div className="text-sm text-(--muted)">Top Rewards</div>
                <ul className="mt-2 text-sm">
              ...
              <GlassCard>
                <div className="text-sm text-(--muted)">Connect Wallet</div>
